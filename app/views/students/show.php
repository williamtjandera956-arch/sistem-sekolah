            ...
            <div class="bg-white shadow rounded-lg p-4">
                <form action="" class="p-4 grid grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <input readonly class="w-full border rounded-lg py-2 px-4" type="text" name="name" id="name"
                            placeholder="Masukkan nama">
                    </div>
                    <div class="space-y-2">
                        <label class="block font-bold" for="nis">NIS</label>
                        <input readonly class="w-full border rounded-lg py-2 px-4" type="text" name="nis" id="nis"
                            placeholder="Masukkan nis">
                    </div>
                    <div class="space-y-2">
                        <label class="block font-bold" for="kelas">Kelas</label>
                        <input readonly class="w-full border rounded-lg py-2 px-4" type="text" name="kelas" id="kelas"
                            placeholder="Masukkan kelas">
                    </div>
                    <div class="space-y-2">
                        <label class="block font-bold" for="phone_number">No Telepon</label>
                        <input readonly class="w-full border rounded-lg py-2 px-4" type="text" name="phone_number"
